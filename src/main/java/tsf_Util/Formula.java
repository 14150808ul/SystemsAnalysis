...
public class Formula
{
	...
	public static double getDeltaVelocityDecrease(Driver eachDriver) {
	...
	public static double getDisplacement_LaneChange( Driver driver ){
		...
		double dt =   TimeControl.TIME_UNIT /* globalContract.ScaleControl.TIME_ScaleRatio */;//why Time 5 I also do not know...
		double v_LC = driver.getVelocity_changeLane();
		double deltaDisplacement_LaneChange = acc_ChangeLane*dt*dt/2 + v_LC * TimeControl.TIME_UNIT;
